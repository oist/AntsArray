...
flash_root="/flash/ReiterU/$USER/$base_folder"
saion_root="/work/ReiterU/$USER/$base_folder"
jobs_root="/flash/ReiterU/$USER/jobs/$base_folder"
saion_jobs_root="/work/ReiterU/$USER/jobs/$base_folder"

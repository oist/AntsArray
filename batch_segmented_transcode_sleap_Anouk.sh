...
sleap_model1=/bucket/ReiterU/Ants/SLEAP_files/ML_class_project/models_centroid_nest/241105_094058.centroid/training_config.json
sleap_model2=/bucket/ReiterU/Ants/SLEAP_files/ML_class_project/models_centroid_nest/241105_094058.centered_instance/training_config.json
...
python /apps/unit/ReiterU/ant_tracking_1/run_aruco.py --video-file ${output_folder}/\\\${video_files[\\\$index]} --output-path ${output_folder}/
...
chmod 2775 /work/ReiterU/ant_tmp/${base_folder}
